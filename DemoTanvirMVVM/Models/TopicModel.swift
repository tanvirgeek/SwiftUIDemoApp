...
let topics:[TopicModel] = [
    ...
    TopicModel(skillName: "FR",SkillDescription: "API integration with URLSession or Alamofire. Also I have worked with firebase for my many projects.", experience: "3 yrs", logo: "fr",  bannerTitle: "fr", bg: "fr"),
